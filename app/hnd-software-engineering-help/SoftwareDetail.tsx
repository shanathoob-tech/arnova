...
const softwareModules = [
  { name: "Programming", slug: "programming", abbreviation: "OOP", price: "Rs. 6,000" },
  ...
  { name: "Applied Programming & Design Principles", slug: "applied-programming-design-principles", abbreviation: "APDP", price: "Rs. 8,000" },
  { name: "Discrete Maths", slug: "discrete-maths", abbreviation: "DM", price: "Rs. 12,000" },
  { name: "User Experience & Interface Design", slug: "user-experience-interface-design", abbreviation: "UEID", price: "Rs. 6,000" },
  { name: "Computing Research Project", slug: "computing-research-project-2", abbreviation: "CRP 2", price: "Rs. 8,000" },
];
...
export default function SoftwareDetail() {
  ...
  const faqs = [
    ["Which programming languages do you support?", "We deliver fully functional programming solutions in Java, C#, C++, Python, PHP, and modern JavaScript frameworks (React, Next.js, Node.js)."],
    ["Do you structure assignments according to design patterns?", "Yes. For advanced modules like APDP and OOP, we construct code utilizing standard design patterns (Singleton, Factory, MVC, Strategy, Observer) and write complete refactoring and architecture reports."],
    ["Do you provide unit test reports?", "Yes. If required, we implement unit testing (JUnit, NUnit, PyTest), construct test suites, compile test case tables, and capture test run logs for your documentation."],
  ];
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1.2fr 0.8fr", gap: "40px", alignItems: "center" }} className="about-grid">
            <div>
              ...
              <h1 className="hero-title" style={{ textAlign: "left", fontSize: "clamp(30px, 4.5vw, 52px)", marginTop: "16px" }}>
                Pearson BTEC HND <br />
                <span className="highlight-text">Software Engineering</span> Assignment Help Sri Lanka
              </h1>
              <p className="hero-subtitle" style={{ textAlign: "left", maxWidth: "100%", margin: "20px 0 32px" }}>
                Distinction-grade programming solutions, object-oriented design specs, data structures codebases, and MVC application architectures written for your Software Engineering stream.
              </p>
            ...
            <div>
              <div className="performance-card">
                <div className="perf-header">
                  <h3 className="perf-title">Software Focus</h3>
                  <span className="perf-tag">Code & Architecture</span>
                </div>
                <div style={{ display: "flex", flexDirection: "column", gap: "10px", margin: "10px 0", fontSize: "14px" }}>
                  <p>✔ Clean OOP Java/C#/Python solutions</p>
                  <p>✔ SOLID design principle mapping</p>
                  <p>✔ Comprehensive UML Class & Seq diagrams</p>
                  <p>✔ Complete test suite logs & reports</p>
                </div>
                <div className="perf-tags">
                  <span className="perf-tag">Design Patterns</span>
                  <span className="perf-tag">Clean Code</span>
                  <span className="perf-tag">Unit Testing</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="about-section theme-light reveal-on-scroll" style={{ padding: "80px 0" }}>
        <div className="section-container">
          <div style={{ textAlign: "center", marginBottom: "48px" }} className="reveal-on-scroll">
            ...
            <h2 className="about-title">Dedicated Software Engineering Module Guides</h2>
          ...
          <div className="bento-grid">
            {softwareModules.map((module, idx) => (
              <a 
        ...
        <div className="section-container">
          <div className="faq-grid-layout-two-col">
            <div className="faq-left-block reveal-on-scroll">
              ...
              <h2 className="faq-main-title">Software Engineering Stream Help</h2>
            </div>
